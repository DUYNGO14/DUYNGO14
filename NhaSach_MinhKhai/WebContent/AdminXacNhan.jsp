            ...
            <div class="container">
                <div class="row pt-3">
                    <div class="col-12 a-left  mb-4 fs-4">
                        <strong class="text-uppercase text-success">Admin xác nhận đặt hàng</strong>
                    </div>
               </div>
    </section>
                    ...
                    <table class="table">
                        ...
                        <tbody>
	                          ...
	                          <tr>
	                            ...
	                            <td><div class="mt-5"><a href="adminxacnhancontroller?mact=${o.machitiethd}">Xác nhận ${o.damua}</a></div></td>
	                          </tr>
	                        </c:forEach>
                        </tbody>
                     </table>
