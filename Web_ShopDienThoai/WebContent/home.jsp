	    ...
	    <c:if test="${quyen==1}">
    	 <table class="table table-hover">
			  ...
			  <tbody>
				<c:forEach items="${dsdt}" var="o">
	            <tr>
              	 	<td><div class="mt-5"><a href="ThongTinSanPhamConTroller?mdt=${o.madt}"><img src="${o.anh}" alt="nah" width="140px" height="160px"></a></div></td>
              	 	<td>
              	 	  <div class="mt-2">
					     ...
					     <p>Dung lượng lưu trữ:${o.dungluong}GB</p>
              	 	 	...
              	 	 	<td><div class="mt-5">${o.gia}đ</div></td>
              	 	 	<td><div class="mt-5">${o.soluong}</div></td>
              	 	 	<td>
              	 	 		<!-- <div class="mt-5"><a href="#"> <i class="fa-solid fa-trash text-danger"></i></a> </div> -->
              	 	 		<a href="HomeController?madtdelete=${o.madt}"><button type="submit" class="btn btn-danger mt-5">Delete</button></a>
                    	</td>
                    	<td>
							<!-- Modal -->
							  ...
							  <div class="modal-dialog">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
									  ...
									  <div class="col-auto">
									    <input type="text" disabled="disabled"  id="inputPassword6" name="madt1" value="${o.madt}" class="form-control" aria-describedby="passwordHelpInline">
									  </div>
									</div>
									<div class="row g-3 align-items-center mb-3">
									  <div class="col-auto">
									  ...
									  <div class="col-auto">
									    <input type="number" disabled="disabled" id="inputPassword6" name="soluongcu" value="${o.soluong}" class="form-control" aria-describedby="passwordHelpInline">
									  </div>
									</div>
							     	<div class="row g-3 align-items-center mb-3">
									  <div class="col-auto">
